      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring absolute top-4 right-4 rounded-md border border-border/80 p-1 text-muted-foreground opacity-85 transition-[opacity,color,border-color,background-color] hover:border-foreground/20 hover:text-foreground hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
